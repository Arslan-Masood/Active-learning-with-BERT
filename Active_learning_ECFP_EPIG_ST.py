...
for task in task_list:
    print("task", task)
#################################
    seed_list = [0,88,100, 142]
    for seed in seed_list:

        config = {
                "seed": seed,
                # directories
                "project_name": "Tox21_ECFP_Final_EPIG",
                "metadata_dir": '/projects/home/mmasood1/trained_model_predictions/Tox21/Frozen_BERT/Main_Aux_tasks_setting/1_main_0_aux/ECFP/',
                ...
                "ECFP_features_file":"/projects/home/mmasood1/arslan_data_repository/Tox21/Tox21_ECFP.csv",
        ...
        for itteration in range(config["num_itterations"]):
            ...
            try:
                ...
                query_set, updated_training_set, updated_poolset = active_learning_loop(trained_model = trained_model,
