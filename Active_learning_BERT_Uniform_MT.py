...
config = {
        # directories
        "project_name": "Tox21_BERT_Uniform_MT_NR_AR_nquery_1",
        "metadata_dir": '/projects/home/mmasood1/trained_model_predictions/Tox21/Frozen_BERT/Main_Aux_tasks_setting/1_main_remaining_aux/Uniform_NR_AR_nquery_1/',
...
config["use_all_tasks_to_split"] = False
...
config["model_weights_dir"] = config["metadata_dir"] + t_names +"/model_weights/"
os.makedirs(query_set_dir, exist_ok = True)
os.makedirs(result_dir, exist_ok = True)
os.makedirs(config["model_weights_dir"], exist_ok = True)

initial_set.to_csv(query_set_dir + "initial_set.csv", index = False)
